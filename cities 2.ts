...
// Farbgruppen wie bei richup.io: alle Städte einer Gruppe gehören zusammen — wer eine
// komplette Gruppe besitzt, darf Häuser/Hotels bauen und kassiert erhöhte Miete.
...
// Miet-Multiplikatoren je Ausbaustufe: 0 = unbebaut, 1-4 = Häuser, 5 = Hotel.
export const RENT_MULTIPLIERS = [1, 2, 3.5, 6, 10, 16];
